...
const messages = defineMessages({
  ...
  sessionsDescription: {
    ...
    defaultMessage:
      "Here are all the devices that are currently logged in with your Inner Core account. You can log out of each one individually.\n\nIf you see an entry you don't recognize, log out of that device and change your Inner Core account password immediately.",
  },

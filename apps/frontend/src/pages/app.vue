...
const title = "Download Horizon!";
const description =
  "Horizon is a unique, pocket launcher that allows you to play your favorite mods, and keep them up to date, all in one neat little package.";
  ...
  <div>
    <div class="landing-hero">
      <h1 class="main-header">
        Download Horizon <br v-if="os" />
        {{ os ? `for ${os}` : "" }}
      </h1>
      <h2 class="main-subheader">
        Horizon is a unique, pocket launcher that allows you to play your favorite mods, and keep
        them up to date, all in one neat little package.
      </h2>
    ...
    <div class="features">
      ...
      <div class="feature-grid">
        <div class="feature gradient-border mods">
          ...
          <p>
            Inner Core makes it easy to manage all your mods in one place. You can install,
            uninstall, and update mods with a single click.
          </p>
        </div>
        <div class="feature gradient-border playing">
          <div class="text">
            <h3>Play with your favorite mods</h3>
            <p>Use Horizon to download and play with your favorite mods and modpacks.</p>
          </div>
          <img
        ...
        <div class="feature gradient-border performance">
          ...
          <div class="table">
            <div class="row first">
              <div class="cell">
                <div>
                  <div class="icon-logo icmods">
                    <LogoAnimated class="icon" />
                  </div>
                </div>
              </div>
              <div class="cell important">Horizon</div>
          ...
          <h3>Performant</h3>
          <p>
            The Inner Core performs better than many of the leading mod managers, using just 150mb
            of RAM!
          </p>
        </div>
        <div class="feature gradient-border website">
          ...
          <p>
            Horizon is fully integrated with the website, so you can access all your favorite
        ...
        <div class="feature gradient-border importing">
          <div class="text">
            ...
            <p>
              ...
              started with Horizon and Inner Core in seconds!
            </p>
          </div>
    ...
    <div ref="downloadSection" class="footer">
      ...
      <div class="section-subheader">
        <div class="section-subheader-title">Download Horizon</div>
      ...
      <p class="terms">
        By downloading Horizon you agree to our
    ...
    <div class="logo-banner">
      ...
      <div class="overlay">
        ...
        <a href="https://vk.com/core_engine" class="iconified-button brand-button">
          Visit the group
        </a>
      </div>
    </div>

...
import { MarkdownEditor, OverflowMenu } from "@icmods/ui";
...
Per section 5.2 of [Inner Core Content Rules](https://modrinth.com/legal/rules#miscellaneous) your project slug (URL) must accurately represent your project. `,
        },
      ],
    },
    {
...
Per section 5.3 of [Inner Core Content Rules](https://modrinth.com/legal/rules#miscellaneous) Your project summary should provide a brief overview of your project that informs and entices users.
This is the first thing most people will see about your mod other than the Logo, so it's important it be accurate, reasonably detailed, and exciting.`,
        },
        {
          ...
          resultingMessage: `## Insufficient Summary
Per section 5.3 of [Inner Core Content Rules](https://modrinth.com/legal/rules#miscellaneous) your Summary can not be the same as your project's Title. Your project summary should provide a brief overview of your project that informs and entices users.
This is the first thing most people will see about your mod other than the Logo, so it's important it be accurate, reasonably detailed, and exciting.`,
        },
        {
          name: "Formatting",
          resultingMessage: `## Insufficient Summary
Per section 5.3 of [Inner Core Content Rules](https://modrinth.com/legal/rules#miscellaneous) your Summary can not include any extra formatting such as lists, or links. Your project summary should provide a brief overview of your project that informs and entices users.
This is the first thing most people will see about your mod other than the Logo, so it's important it be accurate, reasonably detailed, and exciting.`,
        },
      ],
    },
...
Per section 2.1 of [Inner Core Content Rules](https://modrinth.com/legal/rules#general-expectations) your project's Description should clearly inform the reader of the content, purpose, and appeal of your project.
...
Per section 5.4 of [Inner Core Content Rules](https://modrinth.com/legal/rules#miscellaneous) all links must lead to correctly labeled publicly available resources that are directly related to your project.`,
        },
        {
...
Per section 5.1 of [Inner Core Content Rules](https://modrinth.com/legal/rules#miscellaneous), it is important that the metadata of your projects is accurate. Including that selected tags honestly represent your project.`,
        },
      ],
    },
    {
...
Per section 5.1 of [Inner Core Content Rules](https://modrinth.com/legal/rules#miscellaneous), it is important that the metadata of your projects is accurate, including whether the project runs on the client or server side.
...
Per section 5.5 of [Inner Core Content Rules](https://modrinth.com/legal/rules#miscellaneous) any images in your project's Gallery must be relevant to the project and also include a Title.`,
        },
      ],
    },
    {
...
It looks like you've uploaded your Modpack as a \`.zip\`, unfortunately, this is invalid and is why your project type is "Mod". I recommend taking a look at our support page about [Inner Core Modpacks](https://support.modrinth.com/en/articles/8802250-modpacks-on-modrinth), and once you're ready feel free to resubmit your project as a \`.mrpack\`. Don't forget to delete the old files from your Versions!`,
        },
        {
          ...
          resultingMessage: `## Resource Packs on Inner Core Mods
...
Per section 4 of [Inner Core Content Rules](https://modrinth.com/legal/rules) this is strictly forbidden.
...
async function generateMessage() {
  ...
  if (modPackData.value && modPackData.value.length > 0) {
    ...
    if (
      ...
      printMods(
        noMods,
        "The following content is not allowed in Inner Core modpacks due to licensing restrictions. Please contact the author(s) directly for permission or remove the content from your modpack:",
      );
      printMods(
        permanentNoMods,
        "The following content is not allowed in Inner Core modpacks, regardless of permission obtained. This may be because it breaks Inner Core Mods content rules or because the authors, upon being contacted for permission, have declined. Please remove the content from your modpack:",
      );
      printMods(
        unidentifiedMods,
